...
/**
 * Created by Clement on 9/5/2016.
 */
public class ForecastFragment extends Fragment {
    private ArrayAdapter<String> mForecastApater;
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        // Add thie line in order for this fragment to handle menu events.
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        // as you specify a parent activity in AndroidManifet.xml
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        ...
        listView.setAdapter(mForecastApater);
